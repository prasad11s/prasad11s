...
|---------|-------------|-------|------|
| **FinBERT LLM Explainability** | Comparing SHAP vs LIME on FinBERT for financial sentiment analysis on 9,543 tweets | Python, HuggingFace, SHAP, LIME | [Live Demo](https://huggingface.co/spaces/prasad11s/FinBERT-Explainability) |
...
| **Agricultural Yield Prediction** | Gradient Boosted Decision Tree model predicting pollution's impact on rice crop yields across Indian districts (13,215 records) | Python, Gradient Boosting, XGBoost | 
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/prasadshimpi/)
[![HuggingFace](https://img.shields.io/badge/HuggingFace-FFD21E?style=for-the-badge&logo=huggingface&logoColor=black)](https://huggingface.co/prasad11s)
